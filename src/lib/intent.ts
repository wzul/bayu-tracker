...
function buildSystemPrompt(ctx: ClassifyContext): string {
  const availableCommands = [
    ...
    { cmd: "summary", desc: "Admin-only. Show collection overview.", admin: true },
    { cmd: "unit", desc: "Admin-only. Search unit by code or owner name.", admin: true },
    ...
    { cmd: "payments", desc: "Admin-only. List recent payments with summary.", admin: true },
    { cmd: "reports", desc: "Admin-only. Monthly collection report.", admin: true },
    { cmd: "audit", desc: "Admin-only. Recent audit log.", admin: true },
    { cmd: "config", desc: "Admin-only. View system settings.", admin: true },
    { cmd: "deletebill", desc: "Admin-only. Delete a bill by ID or UUID.", admin: true },
    { cmd: "markpaid", desc: "Admin-only. Mark a bill as paid (CASH).", admin: true },
    { cmd: "createunit", desc: "Admin-only. Create a new unit.", admin: true },
    { cmd: "deleteunit", desc: "Admin-only. Delete a unit by code.", admin: true },
