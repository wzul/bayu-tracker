...
5. Create `.env.example` with all required keys (no real values)
6. Commit
...
### E2E Critical Paths
1. Admin imports CSV → units created → bills generated on 1st → resident receives email → resident pays via FPX → webhook marks paid → receipt generated
...
**Week 1:** Tasks 0.1 → 0.2 → 0.3 → 0.4 → 1.1 → 1.2 → 1.3  
**Week 2:** Tasks 2.1 → 2.2 → 2.3 → 2.4 → 2.5 → 3.1 → 3.2 → 3.3  
**Week 3:** Tasks 4.1 → 4.2 → 4.3 → 4.4 → 5.1 → 5.2 → 5.3 → 5.4  
**Week 4:** Tasks 6.1 → 6.2 → 7.1 → 7.2 → 7.3 → 7.4 → 7.5 → 8.1 → 8.2  
**Week 5:** Tasks 9.1 → 9.2 → 9.3 → 9.4 → Testing → Polish → Deploy
